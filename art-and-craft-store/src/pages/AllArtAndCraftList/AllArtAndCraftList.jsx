                    ...
                    <div className="flex items-center justify-center gap-4">
                        <ul className="flex space-x-5 justify-center font-[sans-serif]">
                            ...
                            <li
                                ...
                                className={`${currentPage === pages.length - 1 ? 'cursor-not-allowed bg-gray-100 hover:border-none' : ''} flex items-center justify-center shrink-0 border hover:border-blue-500 cursor-pointer w-9 h-9 rounded-md`}>
